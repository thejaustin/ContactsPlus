...
import com.contactsplus.app.databinding.*
import com.contactsplus.app.database.SocialLinksDatabase
import com.contactsplus.app.dialogs.ChooseSocialDialog
...
class ViewContactActivity : ContactActivity() {
    ...
    private fun gotContact() {
        ...
        arrayOf(
            ...
            binding.contactWebsitesImage, binding.contactGroupsImage, binding.contactSocialLinksImage
        ).forEach {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                if (socialLinks.isNotEmpty()) {
                    ...
                    binding.contactSocialLinksImage.setOnClickListener {
                        showManageSocialLinksDialog()
                    }
                } else {
                    binding.contactSocialLinksImage.beGone()
                    binding.contactSocialLinksHolder.beGone()
                }
            }
        }
    }
